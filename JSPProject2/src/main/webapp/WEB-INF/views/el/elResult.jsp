...
<body>
	...
	<h3>파라미터</h3>
	<ul>
		<li>\${param.name속성값} : request 에 담긴 파라미터 얻어오기 (1개)</li>
	...
	<ul>
		<li>기본 : \${key} (key 는 세팅한 속성의 key값 )</li>
	...
	<p>
		...
		book 의 title : ${book.title} <br>
		book 의 author : ${book.author} <br>
		book 의 price : ${book.price} <br>
	</p>
