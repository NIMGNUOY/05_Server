package edu.kh.mysAgency.common;
	...
	public static Connection getConnection() {
		...
		try {
			...
			if(conn == null || conn.isClosed() ) {
				...
				String filePath 
					= JDBCTemplate.class.getResource("/edu/kh/mysAgency/sql/driver.xml").getPath();
				// C:\workspace\05_Server\JSPProject2\src\main\java\edu\kh\todoList\sql\driver.xml
