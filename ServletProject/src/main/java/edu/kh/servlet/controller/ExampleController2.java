 ...
 * 
 * -> 서버실행시 자동으로 web.xml 에 <servlet> <servlet-mapping> 를 작성하는 효과
 * 
 */
...
public class ExampleController2 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 원래 tomcat9 버전때는 전달받은 값을 얻어와서 확인 -> 한글이 깨지는 문제 발생
		...
		// 누가 이것 좀 대신 만들어주라
		// -> JSP 가 대신 화면을 만들어주라(Servlet 이 JSP에게 요청을 위임)
		
		// JSP 가 대신 화면을 만들어 주기 위해선
		// Servlet 이 어떤 요청을 받았는지 알아야한다
